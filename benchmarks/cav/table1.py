...
pric3_checkers = [
    Pric3Checker("w/o", pric3_common + " --no-generalize"),
    Pric3Checker(
        "lin", pric3_common +
...
storm_checkers = [
    StormChecker("$Storm_{sparse}$", is_dd=False),
    StormChecker("$Storm_{dd}$", is_dd=True),
]
...
print(latex_doc)
results_pdf = compile_latex_document("table1", latex_doc)
